...
MAKE_SLUGS = [
    "mercedes-benz","toyota","bmw","nissan","land-rover","ford","porsche","audi",
    "jeep","volkswagen","hyundai","kia","mitsubishi","ferrari","lexus","chevrolet",
    "rolls-royce","lamborghini","mg","dodge","byd","mazda","honda","infiniti",
    "jetour","bentley","tesla","cadillac","mini","suzuki","gmc","peugeot","jaguar",
    "lincoln","maserati","renault","gac","volvo","aston-martin","mercedes-maybach",
    "geely","alfa-romeo","jac","ram","genesis","rox","zeekr","changan","mclaren",
    "chery","isuzu","xiaomi",
]
