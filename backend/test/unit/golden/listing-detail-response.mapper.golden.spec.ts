...
describe('ListingResponseMapper golden detail responses', () => {
  it('maps listing detail domain data to stable DTO output', () => {
    const detail = {
      id: '1', externalId: 'external-1', marketplace: 'Dubizzle UAE', title: 'Toyota Camry', make: 'Toyota', model: 'Camry', trim: null,
      ...
      neighbourhood: 'Marina', location: 'Dubai', url: 'https://example.test/1', photosCount: 12, firstSeenRunId: '10',
